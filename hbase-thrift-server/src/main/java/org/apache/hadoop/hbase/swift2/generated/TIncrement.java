...
public final class TIncrement
{
    ...
    public TIncrement(
        ...
        @ThriftField(value=2, name="columns", requiredness=Requiredness.REQUIRED) final List<TColumnIncrement> columns,
        @ThriftField(value=4, name="attributes", requiredness=Requiredness.OPTIONAL) final Map<byte[], byte[]> attributes,
        @ThriftField(value=5, name="durability", requiredness=Requiredness.OPTIONAL) final TDurability durability,
        @ThriftField(value=6, name="cellVisibility", requiredness=Requiredness.OPTIONAL) final TCellVisibility cellVisibility
    ) {
        this.row = row;
    ...
    public static class Builder {
        ...
        private List<TColumnIncrement> columns;

        public Builder setColumns(List<TColumnIncrement> columns) {
            this.columns = columns;
            return this;
        }
    ...
    private final List<TColumnIncrement> columns;

    @ThriftField(value=2, name="columns", requiredness=Requiredness.REQUIRED)
    public List<TColumnIncrement> getColumns() { return columns; }

    private final Map<byte[], byte[]> attributes;

    @ThriftField(value=4, name="attributes", requiredness=Requiredness.OPTIONAL)
    public Map<byte[], byte[]> getAttributes() { return attributes; }

    private final TDurability durability;

    @ThriftField(value=5, name="durability", requiredness=Requiredness.OPTIONAL)
    public TDurability getDurability() { return durability; }

    private final TCellVisibility cellVisibility;

    @ThriftField(value=6, name="cellVisibility", requiredness=Requiredness.OPTIONAL)
