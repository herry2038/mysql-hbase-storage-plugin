...
Hbase_truncateTable_args::~Hbase_truncateTable_args() throw() {
}


uint32_t Hbase_truncateTable_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Hbase_truncateTable_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("Hbase_truncateTable_args");
...
Hbase_truncateTable_pargs::~Hbase_truncateTable_pargs() throw() {
}


uint32_t Hbase_truncateTable_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("Hbase_truncateTable_pargs");
...
Hbase_truncateTable_result::~Hbase_truncateTable_result() throw() {
}


uint32_t Hbase_truncateTable_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Hbase_truncateTable_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Hbase_truncateTable_result");
...
Hbase_truncateTable_presult::~Hbase_truncateTable_presult() throw() {
}


uint32_t Hbase_truncateTable_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
Hbase_renameTable_args::~Hbase_renameTable_args() throw() {
}


uint32_t Hbase_renameTable_args::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->newTableName);
...
uint32_t Hbase_renameTable_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("Hbase_renameTable_args");

  xfer += oprot->writeFieldBegin("tableName", ::apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeBinary(this->tableName);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("newTableName", ::apache::thrift::protocol::T_STRING, 2);
  xfer += oprot->writeBinary(this->newTableName);
  xfer += oprot->writeFieldEnd();
...
Hbase_renameTable_pargs::~Hbase_renameTable_pargs() throw() {
}


uint32_t Hbase_renameTable_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("Hbase_renameTable_pargs");
...
Hbase_renameTable_result::~Hbase_renameTable_result() throw() {
}


uint32_t Hbase_renameTable_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Hbase_renameTable_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Hbase_renameTable_result");
...
Hbase_renameTable_presult::~Hbase_renameTable_presult() throw() {
}


uint32_t Hbase_renameTable_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
Hbase_deleteRows_args::~Hbase_deleteRows_args() throw() {
}


uint32_t Hbase_deleteRows_args::read(::apache::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->rows.resize(_size633);
            uint32_t _i637;
            for (_i637 = 0; _i637 < _size633; ++_i637)
            {
              xfer += iprot->readBinary(this->rows[_i637]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.rows = true;
...
uint32_t Hbase_deleteRows_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("Hbase_deleteRows_args");
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->rows.size()));
    std::vector<Text> ::const_iterator _iter638;
    for (_iter638 = this->rows.begin(); _iter638 != this->rows.end(); ++_iter638)
    {
      xfer += oprot->writeBinary((*_iter638));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
...
Hbase_deleteRows_pargs::~Hbase_deleteRows_pargs() throw() {
}


uint32_t Hbase_deleteRows_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("Hbase_deleteRows_pargs");
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRING, static_cast<uint32_t>((*(this->rows)).size()));
    std::vector<Text> ::const_iterator _iter639;
    for (_iter639 = (*(this->rows)).begin(); _iter639 != (*(this->rows)).end(); ++_iter639)
    {
      xfer += oprot->writeBinary((*_iter639));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
...
Hbase_deleteRows_result::~Hbase_deleteRows_result() throw() {
}


uint32_t Hbase_deleteRows_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Hbase_deleteRows_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Hbase_deleteRows_result");
...
Hbase_deleteRows_presult::~Hbase_deleteRows_presult() throw() {
}


uint32_t Hbase_deleteRows_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void HbaseClient::truncateTable(const Text& tableName)
{
  send_truncateTable(tableName);
  recv_truncateTable();
}

void HbaseClient::send_truncateTable(const Text& tableName)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("truncateTable", ::apache::thrift::protocol::T_CALL, cseqid);

  Hbase_truncateTable_pargs args;
  args.tableName = &tableName;
  args.write(oprot_);
...
void HbaseClient::recv_truncateTable()
{
  ...
  Hbase_truncateTable_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void HbaseClient::renameTable(const Text& tableName, const Text& newTableName)
{
  send_renameTable(tableName, newTableName);
  recv_renameTable();
}

void HbaseClient::send_renameTable(const Text& tableName, const Text& newTableName)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("renameTable", ::apache::thrift::protocol::T_CALL, cseqid);

  Hbase_renameTable_pargs args;
  args.tableName = &tableName;
...
void HbaseClient::recv_renameTable()
{
  ...
  Hbase_renameTable_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void HbaseClient::deleteRows(const Text& tableName, const std::vector<Text> & rows)
{
  send_deleteRows(tableName, rows);
  recv_deleteRows();
}

void HbaseClient::send_deleteRows(const Text& tableName, const std::vector<Text> & rows)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("deleteRows", ::apache::thrift::protocol::T_CALL, cseqid);

  Hbase_deleteRows_pargs args;
  args.tableName = &tableName;
  args.rows = &rows;
  args.write(oprot_);
...
void HbaseClient::recv_deleteRows()
{
  ...
  Hbase_deleteRows_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void HbaseProcessor::process_truncateTable(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Hbase.truncateTable", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Hbase.truncateTable");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Hbase.truncateTable");
  }

  Hbase_truncateTable_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Hbase.truncateTable", bytes);
  }

  Hbase_truncateTable_result result;
  try {
    iface_->truncateTable(args.tableName);
  } catch (IOError &io) {
    result.io = io;
    result.__isset.io = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Hbase.truncateTable");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Hbase.truncateTable");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Hbase.truncateTable", bytes);
  }
}

void HbaseProcessor::process_renameTable(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Hbase.renameTable", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Hbase.renameTable");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Hbase.renameTable");
  }

  Hbase_renameTable_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Hbase.renameTable", bytes);
  }

  Hbase_renameTable_result result;
  try {
    iface_->renameTable(args.tableName, args.newTableName);
  } catch (IOError &io) {
    result.io = io;
    result.__isset.io = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Hbase.renameTable");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Hbase.renameTable");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Hbase.renameTable", bytes);
  }
}

void HbaseProcessor::process_deleteRows(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Hbase.deleteRows", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Hbase.deleteRows");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Hbase.deleteRows");
  }

  Hbase_deleteRows_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Hbase.deleteRows", bytes);
  }

  Hbase_deleteRows_result result;
  try {
    iface_->deleteRows(args.tableName, args.rows);
  } catch (IOError &io) {
    result.io = io;
    result.__isset.io = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Hbase.deleteRows");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Hbase.deleteRows");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Hbase.deleteRows", bytes);
  }
}
