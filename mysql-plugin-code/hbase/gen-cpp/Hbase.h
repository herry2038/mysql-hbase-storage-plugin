...
class HbaseIf {
 public:
   ...
   * @param tableName name of table to delete
   */
  virtual void truncateTable(const Text& tableName) = 0;
  virtual void renameTable(const Text& tableName, const Text& newTableName) = 0;
  virtual void deleteRows(const Text& tableName, const std::vector<Text> & rows) = 0;
};
...
class HbaseNull : virtual public HbaseIf {
 public:
  ...
  void truncateTable(const Text& /* tableName */) {
    return;
  }
  void renameTable(const Text& /* tableName */, const Text& /* newTableName */) {
    return;
  }
  void deleteRows(const Text& /* tableName */, const std::vector<Text> & /* rows */) {
    return;
  }
};
...
typedef struct _Hbase_truncateTable_args__isset {
  _Hbase_truncateTable_args__isset() : tableName(false) {}
  bool tableName :1;
} _Hbase_truncateTable_args__isset;

class Hbase_truncateTable_args {
 public:

  static const char* ascii_fingerprint; // = "EFB929595D312AC8F305D5A794CFEDA1";
  static const uint8_t binary_fingerprint[16]; // = {0xEF,0xB9,0x29,0x59,0x5D,0x31,0x2A,0xC8,0xF3,0x05,0xD5,0xA7,0x94,0xCF,0xED,0xA1};

  Hbase_truncateTable_args(const Hbase_truncateTable_args&);
  Hbase_truncateTable_args& operator=(const Hbase_truncateTable_args&);
  Hbase_truncateTable_args() : tableName() {
  }

  virtual ~Hbase_truncateTable_args() throw();
  Text tableName;

  _Hbase_truncateTable_args__isset __isset;

  void __set_tableName(const Text& val);

  bool operator == (const Hbase_truncateTable_args & rhs) const
  {
    if (!(tableName == rhs.tableName))
      return false;
    return true;
  ...
  bool operator < (const Hbase_truncateTable_args & ) const;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);
  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

  friend std::ostream& operator<<(std::ostream& out, const Hbase_truncateTable_args& obj);
};


class Hbase_truncateTable_pargs {
 public:
  ...
  virtual ~Hbase_truncateTable_pargs() throw();
  const Text* tableName;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

  friend std::ostream& operator<<(std::ostream& out, const Hbase_truncateTable_pargs& obj);
};

typedef struct _Hbase_truncateTable_result__isset {
  _Hbase_truncateTable_result__isset() : io(false) {}
  bool io :1;
} _Hbase_truncateTable_result__isset;

class Hbase_truncateTable_result {
 public:

  static const char* ascii_fingerprint; // = "771E7EF40B572D2BFAB12C49547ADCBF";
  static const uint8_t binary_fingerprint[16]; // = {0x77,0x1E,0x7E,0xF4,0x0B,0x57,0x2D,0x2B,0xFA,0xB1,0x2C,0x49,0x54,0x7A,0xDC,0xBF};

  Hbase_truncateTable_result(const Hbase_truncateTable_result&);
  Hbase_truncateTable_result& operator=(const Hbase_truncateTable_result&);
  Hbase_truncateTable_result() {
  }

  virtual ~Hbase_truncateTable_result() throw();
  IOError io;

  _Hbase_truncateTable_result__isset __isset;

  void __set_io(const IOError& val);

  bool operator == (const Hbase_truncateTable_result & rhs) const
  {
    if (!(io == rhs.io))
      return false;
    return true;
  ...
  bool operator < (const Hbase_truncateTable_result & ) const;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);
  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

  friend std::ostream& operator<<(std::ostream& out, const Hbase_truncateTable_result& obj);
};

typedef struct _Hbase_truncateTable_presult__isset {
  _Hbase_truncateTable_presult__isset() : io(false) {}
  bool io :1;
} _Hbase_truncateTable_presult__isset;

class Hbase_truncateTable_presult {
 public:
  ...
  virtual ~Hbase_truncateTable_presult() throw();
  IOError io;

  _Hbase_truncateTable_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

  friend std::ostream& operator<<(std::ostream& out, const Hbase_truncateTable_presult& obj);
};

typedef struct _Hbase_renameTable_args__isset {
  _Hbase_renameTable_args__isset() : tableName(false), newTableName(false) {}
  bool tableName :1;
  bool newTableName :1;
} _Hbase_renameTable_args__isset;

class Hbase_renameTable_args {
 public:

  static const char* ascii_fingerprint; // = "07A9615F837F7D0A952B595DD3020972";
  static const uint8_t binary_fingerprint[16]; // = {0x07,0xA9,0x61,0x5F,0x83,0x7F,0x7D,0x0A,0x95,0x2B,0x59,0x5D,0xD3,0x02,0x09,0x72};

  Hbase_renameTable_args(const Hbase_renameTable_args&);
  Hbase_renameTable_args& operator=(const Hbase_renameTable_args&);
  Hbase_renameTable_args() : tableName(), newTableName() {
  }

  virtual ~Hbase_renameTable_args() throw();
  Text tableName;
  Text newTableName;

  _Hbase_renameTable_args__isset __isset;

  void __set_tableName(const Text& val);

  void __set_newTableName(const Text& val);

  bool operator == (const Hbase_renameTable_args & rhs) const
  {
    if (!(tableName == rhs.tableName))
      return false;
  ...
  bool operator < (const Hbase_renameTable_args & ) const;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);
  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

  friend std::ostream& operator<<(std::ostream& out, const Hbase_renameTable_args& obj);
};


class Hbase_renameTable_pargs {
 public:
  ...
  virtual ~Hbase_renameTable_pargs() throw();
  const Text* tableName;
  const Text* newTableName;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

  friend std::ostream& operator<<(std::ostream& out, const Hbase_renameTable_pargs& obj);
};

typedef struct _Hbase_renameTable_result__isset {
  _Hbase_renameTable_result__isset() : io(false) {}
  bool io :1;
} _Hbase_renameTable_result__isset;

class Hbase_renameTable_result {
 public:

  static const char* ascii_fingerprint; // = "771E7EF40B572D2BFAB12C49547ADCBF";
  static const uint8_t binary_fingerprint[16]; // = {0x77,0x1E,0x7E,0xF4,0x0B,0x57,0x2D,0x2B,0xFA,0xB1,0x2C,0x49,0x54,0x7A,0xDC,0xBF};

  Hbase_renameTable_result(const Hbase_renameTable_result&);
  Hbase_renameTable_result& operator=(const Hbase_renameTable_result&);
  Hbase_renameTable_result() {
  }

  virtual ~Hbase_renameTable_result() throw();
  IOError io;

  _Hbase_renameTable_result__isset __isset;

  void __set_io(const IOError& val);

  bool operator == (const Hbase_renameTable_result & rhs) const
  {
    if (!(io == rhs.io))
      return false;
    return true;
  ...
  bool operator < (const Hbase_renameTable_result & ) const;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);
  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

  friend std::ostream& operator<<(std::ostream& out, const Hbase_renameTable_result& obj);
};

typedef struct _Hbase_renameTable_presult__isset {
  _Hbase_renameTable_presult__isset() : io(false) {}
  bool io :1;
} _Hbase_renameTable_presult__isset;

class Hbase_renameTable_presult {
 public:
  ...
  virtual ~Hbase_renameTable_presult() throw();
  IOError io;

  _Hbase_renameTable_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

  friend std::ostream& operator<<(std::ostream& out, const Hbase_renameTable_presult& obj);
};

typedef struct _Hbase_deleteRows_args__isset {
  _Hbase_deleteRows_args__isset() : tableName(false), rows(false) {}
  bool tableName :1;
  bool rows :1;
} _Hbase_deleteRows_args__isset;

class Hbase_deleteRows_args {
 public:
  ...
  Hbase_deleteRows_args(const Hbase_deleteRows_args&);
  Hbase_deleteRows_args& operator=(const Hbase_deleteRows_args&);
  Hbase_deleteRows_args() : tableName() {
  }

  virtual ~Hbase_deleteRows_args() throw();
  Text tableName;
  std::vector<Text>  rows;

  _Hbase_deleteRows_args__isset __isset;

  void __set_tableName(const Text& val);

  void __set_rows(const std::vector<Text> & val);

  bool operator == (const Hbase_deleteRows_args & rhs) const
  {
    if (!(tableName == rhs.tableName))
      return false;
    if (!(rows == rhs.rows))
  ...
  bool operator < (const Hbase_deleteRows_args & ) const;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);
  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

  friend std::ostream& operator<<(std::ostream& out, const Hbase_deleteRows_args& obj);
};


class Hbase_deleteRows_pargs {
 public:
  ...
  virtual ~Hbase_deleteRows_pargs() throw();
  const Text* tableName;
  const std::vector<Text> * rows;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

  friend std::ostream& operator<<(std::ostream& out, const Hbase_deleteRows_pargs& obj);
};

typedef struct _Hbase_deleteRows_result__isset {
  _Hbase_deleteRows_result__isset() : io(false) {}
  bool io :1;
} _Hbase_deleteRows_result__isset;

class Hbase_deleteRows_result {
 public:

  static const char* ascii_fingerprint; // = "771E7EF40B572D2BFAB12C49547ADCBF";
  static const uint8_t binary_fingerprint[16]; // = {0x77,0x1E,0x7E,0xF4,0x0B,0x57,0x2D,0x2B,0xFA,0xB1,0x2C,0x49,0x54,0x7A,0xDC,0xBF};

  Hbase_deleteRows_result(const Hbase_deleteRows_result&);
  Hbase_deleteRows_result& operator=(const Hbase_deleteRows_result&);
  Hbase_deleteRows_result() {
  }

  virtual ~Hbase_deleteRows_result() throw();
  IOError io;

  _Hbase_deleteRows_result__isset __isset;

  void __set_io(const IOError& val);

  bool operator == (const Hbase_deleteRows_result & rhs) const
  {
    if (!(io == rhs.io))
      return false;
    return true;
  ...
  bool operator < (const Hbase_deleteRows_result & ) const;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);
  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

  friend std::ostream& operator<<(std::ostream& out, const Hbase_deleteRows_result& obj);
};

typedef struct _Hbase_deleteRows_presult__isset {
  _Hbase_deleteRows_presult__isset() : io(false) {}
  bool io :1;
} _Hbase_deleteRows_presult__isset;

class Hbase_deleteRows_presult {
 public:
  ...
  virtual ~Hbase_deleteRows_presult() throw();
  IOError io;

  _Hbase_deleteRows_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

  friend std::ostream& operator<<(std::ostream& out, const Hbase_deleteRows_presult& obj);
};
...
class HbaseClient : virtual public HbaseIf {
 ...
 public:
  ...
  void truncateTable(const Text& tableName);
  void send_truncateTable(const Text& tableName);
  void recv_truncateTable();
  void renameTable(const Text& tableName, const Text& newTableName);
  void send_renameTable(const Text& tableName, const Text& newTableName);
  void recv_renameTable();
  void deleteRows(const Text& tableName, const std::vector<Text> & rows);
  void send_deleteRows(const Text& tableName, const std::vector<Text> & rows);
...
class HbaseProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  HbaseProcessor(boost::shared_ptr<HbaseIf> iface) :
    ...
    processMap_["truncateTable"] = &HbaseProcessor::process_truncateTable;
    processMap_["renameTable"] = &HbaseProcessor::process_renameTable;
    processMap_["deleteRows"] = &HbaseProcessor::process_deleteRows;
  }
...
class HbaseMultiface : virtual public HbaseIf {
 ...
 public:
  ...
  void truncateTable(const Text& tableName) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->truncateTable(tableName);
    }
    ifaces_[i]->truncateTable(tableName);
  }
  ...
  void renameTable(const Text& tableName, const Text& newTableName) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->renameTable(tableName, newTableName);
    }
    ifaces_[i]->renameTable(tableName, newTableName);
  }
  ...
  void deleteRows(const Text& tableName, const std::vector<Text> & rows) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->deleteRows(tableName, rows);
    }
    ifaces_[i]->deleteRows(tableName, rows);
  }
